...
const HeroSection = () => {
  return (
    <div className='hero-wrapper flex flex-col items-center mt-6'>
        ...
        <p className='mt-10 text-lg text-center text-neutral-500 max-w-4xl'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Explicabo esse, architecto quidem sed magnam qui. Magnam pariatur dolorem harum accusantium velit qui laudantium ducimus, ullam animi dolor, aliquid voluptas facilis.</p>
        ...
        {/* Video Clips */}
        <div className='video-wrapper flex flex-col gap-2 md:flex-row mt-10 justify-center md:py-[0.75rem] px-[1.5rem]'>
          {
